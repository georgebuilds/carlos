...
// usermodel.go (confirm-before-write user model).
//
// Kept as a small file so the package layout reads naturally; do not
// re-add types here without a thematic reason.
package memory
